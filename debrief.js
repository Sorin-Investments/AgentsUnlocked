...
export default async function handler(req) {
  ...
  // Check how many debriefs submitted so far
  ...
  return json({
    ...
    message: `Debrief received. ${count} of 150 agents have submitted debriefs. The collective intelligence report will be published once 80%+ have submitted.`,
    brief_your_human: {
